package Anansi::Script::FastCGI;


=head1 NAME

Anansi::Script::FastCGI - Defines the mechanisms specific to handling FSGI execution.

=head1 SYNOPSIS

    my $OBJECT = Anansi::Script::FastCGI->new();
...
by a web server using the Fast Common Gateway Interface.  Uses
...
Anansi::Component::addChannel('Anansi::Script::CGI', 'PRIORITY_OF_VALIDATE' => 'priority');
