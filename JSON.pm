...
Anansi::Component::addChannel('Anansi::Script::JSON', 'MEDIUM' => 'medium');
...
Anansi::Component::addChannel('Anansi::Script::JSON', 'PARAMETER' => 'parameter');
...
Anansi::Component::addChannel('Anansi::Script::JSON', 'PRIORITY_OF_VALIDATE' => 'priority');
...
Anansi::Component::addChannel('Anansi::Script::JSON', 'VALIDATE_AS_APPROPRIATE' => 'validate');
